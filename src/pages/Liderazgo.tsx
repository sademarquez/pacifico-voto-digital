      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-4 flex items-center justify-center">
            <Crown className="w-8 h-8 mr-3 text-slate-600" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="text-center border-l-4 border-l-stone-600">
            <CardContent className="p-4">
          ...
          <Card className="text-center border-l-4 border-l-amber-600">
            <CardContent className="p-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          {lideres.map((lider) => (
            <Card 
              key={lider.id} 
              className="hover:shadow-lg transition-all duration-300 cursor-pointer border-slate-200"
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-lg text-slate-800">{lider.nombre}</CardTitle>
        ...
        {liderSeleccionado && (
          <Card className="bg-gradient-to-r from-slate-50 to-stone-50 border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg border-b border-slate-200 pb-2 text-slate-800">Información General</h3>
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg border-b border-slate-200 pb-2 text-slate-800">Métricas de Impacto</h3>
                  
                  <div className="space-y-3">
                    <div className="bg-white p-4 rounded-lg border border-slate-200">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-slate-600">Miembros Registrados</span>
                        <Badge variant="outline" className="border-slate-300 text-slate-700">{liderSeleccionado.miembrosRegistrados}</Badge>
                      </div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-slate-200">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant="outline" className="border-slate-300 text-slate-700">{liderSeleccionado.alertasReportadas}</Badge>
                      </div>
                  ...
                  <div className="flex gap-2 pt-4">
                    ...
                    <Button variant="outline" size="sm" className="flex-1 border-slate-300 text-slate-700 hover:bg-slate-100">
        ...
        {/* Call to Action */}
        <Card className="bg-gradient-to-r from-slate-600 to-stone-600 text-white mt-8">
