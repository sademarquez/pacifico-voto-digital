        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-slate-700 drop-shadow-sm">
                Wramba Fxiw
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Button className="bg-slate-700 hover:bg-slate-800 text-white shadow-lg hover:shadow-xl rounded-lg px-6 transition-shadow">
                Mi Perfil
              </Button>
            </div>
            ...
            <div className="md:hidden">
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                <SheetTrigger asChild>
                  <Button variant="ghost" size="icon" className="text-slate-600 shadow-sm hover:shadow-md">
                    <Menu className="w-6 h-6" />
                  </Button>
                </SheetTrigger>
                <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-gray-50 shadow-2xl">
                  <div className="flex flex-col space-y-4 mt-8">
                    ...
                    <Button className="bg-slate-700 hover:bg-slate-800 text-white mt-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                      Mi Perfil
                    </Button>
                  </div>
                </SheetContent>
            ...
            <Link
              ...
              className={`flex flex-col items-center p-3 rounded-lg transition-all duration-300 ${
                isActiveRoute(item.href)
                  ...
                  : 'text-slate-600 hover:bg-slate-100 hover:text-slate-700 shadow-sm hover:shadow-md'
              }`}
            >
