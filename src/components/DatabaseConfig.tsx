...
const DatabaseConfig = () => {
  ...
  const { getStats, validateRequiredKeys } = useAPIKeys();

  const apiStats = getStats();
  const keyValidation = validateRequiredKeys();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="border-verde-sistema-200">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              <Database className="w-5 h-5 text-verde-sistema-600" />
              <div>
                <div className="font-medium text-sm">Base de Datos</div>
                <div className="text-xs text-negro-600">Local JSON</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-verde-sistema-200">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              <Key className="w-5 h-5 text-verde-sistema-600" />
              <div>
                <div className="font-medium text-sm">API Keys</div>
                <div className="text-xs text-negro-600">{apiStats.active}/{apiStats.total} activas</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-verde-sistema-200">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              <Zap className="w-5 h-5 text-verde-sistema-600" />
              <div>
                <div className="font-medium text-sm">Servicios</div>
                <div className="text-xs text-negro-600">{keyValidation.valid ? 'Completo' : 'Pendiente'}</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-negro-600">
                  {keyValidation.valid ? 'Listo' : 'Config. pendiente'}
                </div>
              </div>
            </div>
          </CardContent>
